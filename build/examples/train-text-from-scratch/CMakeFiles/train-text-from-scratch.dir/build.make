...
examples/train-text-from-scratch/CMakeFiles/train-text-from-scratch.dir/train-text-from-scratch.cpp.o: ../examples/train-text-from-scratch/train-text-from-scratch.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/root/AICAS/llama-cpp-python/vendor/llama.cpp/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object examples/train-text-from-scratch/CMakeFiles/train-text-from-scratch.dir/train-text-from-scratch.cpp.o"
	cd /root/AICAS/llama-cpp-python/vendor/llama.cpp/build/examples/train-text-from-scratch && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/train-text-from-scratch.dir/train-text-from-scratch.cpp.o -c /root/AICAS/llama-cpp-python/vendor/llama.cpp/examples/train-text-from-scratch/train-text-from-scratch.cpp
...
bin/train-text-from-scratch: examples/train-text-from-scratch/CMakeFiles/train-text-from-scratch.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/root/AICAS/llama-cpp-python/vendor/llama.cpp/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/train-text-from-scratch"
	cd /root/AICAS/llama-cpp-python/vendor/llama.cpp/build/examples/train-text-from-scratch && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/train-text-from-scratch.dir/link.txt --verbose=$(VERBOSE)
...
examples/train-text-from-scratch/CMakeFiles/train-text-from-scratch.dir/clean:
	cd /root/AICAS/llama-cpp-python/vendor/llama.cpp/build/examples/train-text-from-scratch && $(CMAKE_COMMAND) -P CMakeFiles/train-text-from-scratch.dir/cmake_clean.cmake
